...
@RunWith(Suite.class)
@SuiteClasses({ ChessBoardTest.class,PawnMoveHandlerTest.class,RookMoveHandlerTest.class,BishopMoveHandlerTest.class, PiecesMoveManagerTest.class,PieceTest.class })
